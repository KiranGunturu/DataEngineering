...
full - 0 + 5 + 10 = 15
 ...
 from 'hdfs://bdedev/data/claims/wrnty_clm_splmnt_base' to  'hdfs://bdestg/data/claims/wrnty_clm_splmnt_base'
 from  'hdfs://bdedev/data/claims/wrnty_clm_splmnt_raw' to  'hdfs://bdestg/data/claims/wrnty_clm_splmnt_raw'
 ...
 natural join
 ============
 it does the join based on common column names and it will try to do inner join
 
 8 records if same column name exists
 or 
 if the same column name does not exists then output is more like a cross join - 42
